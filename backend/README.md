...
# O servidor inciará na porta:8000 - acesse <http://localhost:8000/pratos>

# Para ver informações nutricionais sobre um prato - acesse <http://localhost:8000/pratos/id_do_prato>
